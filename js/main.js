...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _swipers_top_slider__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./swipers/_top-slider */ "./src/js/swipers/_top-slider.js");
/* harmony import */ var _swipers_preview_products__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./swipers/_preview-products */ "./src/js/swipers/_preview-products.js");
/* harmony import */ var _swipers_product_slider__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./swipers/_product-slider */ "./src/js/swipers/_product-slider.js");

(0,_swipers_top_slider__WEBPACK_IMPORTED_MODULE_0__.topSlider)();

(0,_swipers_preview_products__WEBPACK_IMPORTED_MODULE_1__.previewProductsSlider)();

(0,_swipers_product_slider__WEBPACK_IMPORTED_MODULE_2__.productSlider)();
...
(0,_templates_burger__WEBPACK_IMPORTED_MODULE_0__.burger)(); // * Реализация модального окна
...
if (document.querySelector('.modal-login')) {
  ...
  btnLogin.addEventListener('click', () => {
    const modal = new graph_modal__WEBPACK_IMPORTED_MODULE_1__["default"]('modal').open('modal-login');
  }); //btnLogin.click();
}
...
if (document.querySelector('.modal-authorization')) {
  ...
  btnAuthorization.addEventListener('click', () => {
    const modal = new graph_modal__WEBPACK_IMPORTED_MODULE_1__["default"]('modal').open('modal-authorization');
  }); // btnAuthorization.click();
} // * Реализация табов



const menuLinks = (_document = document) === null || _document === void 0 ? void 0 : _document.querySelectorAll('[data-menu-link]');

if (document.querySelector('[data-tabs="dealers"]')) {
  const tabs = new graph_tabs__WEBPACK_IMPORTED_MODULE_2__["default"]('dealers');
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "filterToggle": () => (/* binding */ filterToggle)
/* harmony export */ });
const filterToggle = () => {
...
/***/ "./src/js/swipers/_preview-products.js":
/*!*********************************************!*\
  !*** ./src/js/swipers/_preview-products.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/js/swipers/_product-slider.js":
/*!*******************************************!*\
  !*** ./src/js/swipers/_product-slider.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const burger = () => {
  ...
  const menuLinks = (_document3 = document) === null || _document3 === void 0 ? void 0 : _document3.querySelectorAll('[data-menu-link]');
  ...
  menuLinks === null || menuLinks === void 0 ? void 0 : menuLinks.forEach(el => {
